...
class Frame18 extends StatefulWidget {
  @override
  _Frame18State createState() => _Frame18State();
}

class _Frame18State extends State<Frame18> {
  final _client = Supabase.instance.client;
  List<Reformers?> reformers = List.filled(72, null);
  User? user;
