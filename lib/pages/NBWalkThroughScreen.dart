        ...
        children: [
          Column(
            children: [
              ...
              16.height,
              Text('Pilates Studio', style: boldTextStyle(size: 20)).paddingOnly(left: 16, right: 16),
              16.height,
              Text(
                'PilatesStudio uygulamasına hoşgeldiniz! PilatesStudio her zaman öğrencilerini mutlu görmek ister! :)',
